...
plot1<- ggplot(housing_data, aes(x = sqft_living, y = price)) +
    geom_point() + ggtitle("Figure 1: Scatterplot of the Raw Data") + xlab("predictor variables")
#cleaning data
...
plot2<- ggplot(housing_data, aes(x = sqft_living, y = price)) +
    geom_point() + ggtitle("Figure 2: Scatterplot of the Cleaned Data") + xlab("predictor variables")
...
10. Harlfoxem. “House Sales in King County, USA,” August 25, 2016. https://www.kaggle.com/harlfoxem/housesalesprediction.  
...
35. Tinytex Package: Yihui Xie, 2020. tinytex: Helper Functions to Install and Maintain TeX Live, and Compile LaTeX Documents. R
